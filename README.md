# Available .BOUTIQUE One-Word Domains (9,162)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-9%2C165%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-9%2C162%20domains-6f42c1">
...
**Public extract:** 9,165 rows · **Live catalog:** 9,162 domains
...
- `boutique.csv` — public CSV extract (9,165 rows)
- `boutique.json` — public JSON extract (9,165 rows)
...
| eternal.boutique    | available | $6.99     | $46.99        | 92             | 40     | 7      | name.com        |
...
| star.boutique       | premium   | $500      | $500          | 86             | 45     | 4      | name.com        |
| about.boutique      | available | $6.99     | $46.99        | 94             | 38     | 5      | name.com        |
...
| ----------------------- | ------------------------------------------------ |
| 9,165-row public sample | 9,162 live domains                               |
...
> Unique Domains. *Available .BOUTIQUE One-Word Domains*. Version 2026-04-11. Public GitHub extract for the exact Unique Domains search represented by this repository.
